...
-- Started on 2026-05-11 19:28:51
...
--
-- TOC entry 843 (class 1247 OID 16948)
-- Name: card_status_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.card_status_enum OWNER TO postgres;

--
-- TOC entry 846 (class 1247 OID 16958)
-- Name: card_txn_type_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.card_txn_type_enum OWNER TO postgres;

--
-- TOC entry 840 (class 1247 OID 16935)
...
--
-- TOC entry 858 (class 1247 OID 17006)
...
-- Name: card_accounts; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.card_accounts OWNER TO postgres;
...
-- Name: payment_behaviour; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.payment_behaviour OWNER TO postgres;

--
-- TOC entry 216 (class 1259 OID 16988)
-- Name: spend_aggregates; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.spend_aggregates OWNER TO postgres;

--
-- TOC entry 3391 (class 0 OID 16967)
-- Dependencies: 214
-- Data for Name: card_accounts; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3392 (class 0 OID 16975)
-- Dependencies: 215
...
--
-- TOC entry 3394 (class 0 OID 17015)
-- Dependencies: 217
-- Data for Name: payment_behaviour; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3393 (class 0 OID 16988)
-- Dependencies: 216
-- Data for Name: spend_aggregates; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3238 (class 2606 OID 16974)
-- Name: card_accounts card_accounts_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: payment_behaviour payment_behaviour_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3243 (class 2606 OID 16999)
-- Name: spend_aggregates spend_aggregates_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3239 (class 1259 OID 24578)
-- Name: idx_card_accounts_pan; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3246 (class 2606 OID 16983)
...
--
-- TOC entry 3248 (class 2606 OID 17022)
-- Name: payment_behaviour payment_behaviour_card_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3247 (class 2606 OID 17000)
-- Name: spend_aggregates spend_aggregates_card_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Completed on 2026-05-11 19:28:52
