...
-- Started on 2026-05-11 19:29:32
...
--
-- TOC entry 852 (class 1247 OID 16434)
...
--
-- TOC entry 849 (class 1247 OID 16420)
...
--
-- TOC entry 840 (class 1247 OID 16390)
...
--
-- TOC entry 861 (class 1247 OID 16466)
-- Name: liability_type_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.liability_type_enum OWNER TO postgres;

--
-- TOC entry 843 (class 1247 OID 16398)
-- Name: segment_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.segment_enum OWNER TO postgres;

--
-- TOC entry 858 (class 1247 OID 16448)
-- Name: txn_channel_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.txn_channel_enum OWNER TO postgres;

--
-- TOC entry 855 (class 1247 OID 16442)
...
-- Name: liability_accounts; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.liability_accounts OWNER TO postgres;
...
--
-- TOC entry 3402 (class 0 OID 16492)
-- Dependencies: 215
...
ACC0000000017	CUST000011	SAVINGS	INR	1500000.00	1500000.00	0.00	ACTIVE	2016-11-10	BLR001
\.


--
-- TOC entry 3401 (class 0 OID 16479)
-- Dependencies: 214
...
--
-- TOC entry 3404 (class 0 OID 16516)
-- Dependencies: 217
-- Data for Name: liability_accounts; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3403 (class 0 OID 16505)
-- Dependencies: 216
...
TXN0000000019	ACC0000000017	2025-04-01	CREDIT	291667.00	INR	NEFT	Infosys BPM Ltd	INFY00012345	Monthly consulting retainer Apr-2025	1500000.00
\.
...
--
-- TOC entry 3245 (class 2606 OID 16491)
-- Name: customer_master customer_master_pan_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3247 (class 2606 OID 16489)
-- Name: customer_master customer_master_party_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3255 (class 2606 OID 16522)
-- Name: liability_accounts liability_accounts_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3253 (class 2606 OID 16510)
...
-- Name: account_master account_master_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: liability_accounts liability_accounts_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: transaction_history transaction_history_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Completed on 2026-05-11 19:29:32
