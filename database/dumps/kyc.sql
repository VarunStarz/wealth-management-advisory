...
ALTER TABLE IF EXISTS ONLY public.kyc_master DROP CONSTRAINT IF EXISTS kyc_master_customer_id_key;
...
--
-- Name: kyc_master kyc_master_customer_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: risk_classification risk_classification_customer_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
